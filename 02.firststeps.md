...
Next up we have something called 'Forward Declarations`. Here's something about C/C++ - you can use something until you declare it. You have to define variable before you use them, right? Well, you have to do the same thing with functions:
...
It sure is. But in C/C++, you'll find that symbols often have different meanings depending on the context.  In this context, it represents a pointer and we discussed those in the previous article.
